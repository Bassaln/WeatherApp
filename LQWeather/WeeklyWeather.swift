...
class WeeklyWeather: NSObject,Storable {
...
extension WeeklyWeather{
    ...
    class func fromDictionary(dictionary: NSDictionary) -> WeeklyWeather	{
        let this = WeeklyWeather()
...
//MARK: - 设置主键
extension WeeklyWeather:PrimaryKeys{
